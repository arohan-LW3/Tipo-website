...
export default function CommunitySection() {
  return (
    <section className="bg-brand-black py-20 md:py-28 mt-0 md:-mt-[120px]">
      <div className="max-w-[clamp(1152px,75vw,1800px)] mx-auto px-10 md:px-[clamp(64px,5.5vw,120px)] grid grid-cols-1 md:grid-cols-2 gap-x-8 md:gap-x-[clamp(40px,3vw,80px)] gap-y-12 items-start">
        ...
        <div data-parallax-text className="flex flex-col gap-4 order-2 md:order-2 w-full md:max-w-[clamp(480px,33.3vw,680px)] md:py-20">
          ...
          <div className="tx-body flex flex-col gap-4">
            <p className="text-[clamp(16px,1.11vw,22px)] leading-[1.8] text-brand-text">
