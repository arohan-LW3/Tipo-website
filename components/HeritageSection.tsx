  ...
  return (
    <section id="heritage" className="bg-brand-black pt-[clamp(80px,7vw,140px)] pb-[clamp(44px,3vw,80px)] scroll-mt-20">
      <div className="max-w-[clamp(1152px,75vw,1800px)] mx-auto px-10 md:px-[clamp(64px,5.5vw,120px)]">
        {/* Eyebrow label */}
        <div className="mb-8">
          <span className="animate-glow-drl tx-serif-bold text-[clamp(14px,0.97vw,20px)] uppercase tracking-[0.25em] text-[#D4922A] inline-block border-b border-[#D4922A] pb-0.5">
            The Team
          </span>
        </div>
